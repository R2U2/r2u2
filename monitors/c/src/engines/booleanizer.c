...
r2u2_status_t r2u2_bz_instruction_dispatch(r2u2_monitor_t *monitor, r2u2_bz_instruction_t *instr)
{
    ...
    switch(instr->opcode) {
        ...
        case R2U2_BZ_OP_BWNEG:
            ...
            (monitor->value_buffer)[instr->memory_reference].i = i2;
        ...
        case R2U2_BZ_OP_BWAND:
            ...
            (monitor->value_buffer)[instr->memory_reference].i = i3;
        ...
        case R2U2_BZ_OP_FNEG:
            ...
            (monitor->value_buffer)[instr->memory_reference].f = f2;
        ...
        case R2U2_BZ_OP_FADD:
            ...
            (monitor->value_buffer)[instr->memory_reference].f = f3;
