...
pub fn bz_update(monitor: &mut Monitor){
    ...
    match instr.opcode{
        ...
        BZ_OP_STORE => {
            ...
            let op = monitor.value_buffer[LittleEndian::read_u32(&instr.param1) as usize].i;
        ...
        BZ_OP_BWAND=> {
            ...
            let op0 = monitor.value_buffer[LittleEndian::read_u32(&instr.param1) as usize].i;
        ...
        BZ_OP_FEQ=> {
            debug_print!("BZ FEQ");
            let op0 = monitor.value_buffer[LittleEndian::read_u32(&instr.param1) as usize].f;
