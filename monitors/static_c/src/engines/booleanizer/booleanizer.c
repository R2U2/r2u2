...
r2u2_status_t r2u2_bz_instruction_dispatch(r2u2_monitor_t *monitor, r2u2_bz_instruction_t *instr)
{
    ...
    switch(inst_buff.opcode) {
        ...
        case R2U2_BZ_OP_STORE:
            (*(monitor->atomic_buffer)[0])[inst_buff.param2] = (*monitor->value_buffer)[inst_buff.param1.bz_addr].b;

            R2U2_DEBUG_PRINT("\ta%d = %hhu (b%d)\n", inst_buff.param2, (*(monitor->atomic_buffer)[0])[inst_buff.param2], param1.bz_addr);
            break;
        /* Bitwise */
        ...
        case R2U2_BZ_OP_IEQ:
            ...
            (*monitor->value_buffer)[inst_buff.memory_reference].b = b;
