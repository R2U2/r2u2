...
r2u2_status_t r2u2_bz_instruction_dispatch(r2u2_monitor_t *monitor, r2u2_bz_instruction_t *instr)
{
    ...
    switch(inst_buff.opcode) {
        ...
        case R2U2_BZ_OP_STORE:
            (*(monitor->atomic_buffer)[0])[inst_buff.param2] = (r2u2_bool)(*monitor->value_buffer)[inst_buff.param1.bz_addr];
            R2U2_DEBUG_PRINT("\tBZ STORE\n");    
            R2U2_DEBUG_PRINT("\ta%d = %s (b%d)\n", inst_buff.param2, (*(monitor->atomic_buffer)[0])[inst_buff.param2] ? "T" : "F", inst_buff.param1.bz_addr);
            break;
        /* Bitwise */
        case R2U2_BZ_OP_BWNEG:
            i1 = (*monitor->value_buffer)[inst_buff.param1.bz_addr];
            i2 = ~i1;

            (*monitor->value_buffer)[inst_buff.memory_reference]= i2;
        ...
        case R2U2_BZ_OP_BWAND:
            i1 = (*monitor->value_buffer)[inst_buff.param1.bz_addr];
            i2 = (*monitor->value_buffer)[inst_buff.param2];
            i3 = i1 & i2;

            (*monitor->value_buffer)[inst_buff.memory_reference] = i3;
        ...
        case R2U2_BZ_OP_IEQ:
            ...
            (*monitor->value_buffer)[inst_buff.memory_reference] = b;
            ...
            break;
        case R2U2_BZ_OP_FEQ:
            f1 = (*monitor->value_buffer)[inst_buff.param1.bz_addr];
            f2 = (*monitor->value_buffer)[inst_buff.param2];
        ...
        case R2U2_BZ_OP_FNEG:
            ...
            (*monitor->value_buffer)[inst_buff.memory_reference] = f2;
        ...
        case R2U2_BZ_OP_FADD:
            ...
            (*monitor->value_buffer)[inst_buff.memory_reference] = f3;
        ...
        case R2U2_BZ_OP_PREV:
            ...
            R2U2_DEBUG_PRINT("\tb%d = %f (s%d)\n", inst_buff.memory_reference, (*monitor->value_buffer)[inst_buff.memory_reference], inst_buff.param1.bz_addr);
            break;
        default:
