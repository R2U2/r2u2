...
typedef enum r2u2_bz_opcode {
    ...
    /* Loads and Store */
    R2U2_BZ_OP_LOAD    = 0b000001,
    R2U2_BZ_OP_STORE   = 0b000010,
    ...
    R2U2_BZ_OP_FGTE    = 0b010000,
    R2U2_BZ_OP_ILT     = 0b010001,
    R2U2_BZ_OP_FLT     = 0b010010,
    R2U2_BZ_OP_ILTE    = 0b010011,
    R2U2_BZ_OP_FLTE    = 0b010100,
    /* Arithmetic */
    R2U2_BZ_OP_INEG    = 0b010101,
    R2U2_BZ_OP_FNEG    = 0b010110,
    R2U2_BZ_OP_IADD    = 0b010111,
    R2U2_BZ_OP_FADD    = 0b011000,
    R2U2_BZ_OP_ISUB    = 0b011001,
    R2U2_BZ_OP_FSUB    = 0b011010,
    R2U2_BZ_OP_IMUL    = 0b011011,
    R2U2_BZ_OP_FMUL    = 0b011100,
    R2U2_BZ_OP_IDIV    = 0b011101,
    R2U2_BZ_OP_FDIV    = 0b011110,
    R2U2_BZ_OP_MOD     = 0b011111,
    R2U2_BZ_OP_IPOW    = 0b100000,
    R2U2_BZ_OP_FPOW    = 0b100001,
    R2U2_BZ_OP_ISQRT   = 0b100010,
    R2U2_BZ_OP_FSQRT   = 0b100011,
    R2U2_BZ_OP_IABS    = 0b100100,
    R2U2_BZ_OP_FABS    = 0b100101,
    R2U2_BZ_OP_PREV   = 0b100110,
} r2u2_bz_opcode_t;
