# Python Script to make formulas for regression testing
...
# test0018 - Test Case testing negation of a value that should always be true
  - " !(x & x) "
  
# test0019 - Test Case testing interval operation with an input that should always be true
  - " G[5] (x & x) "
  
# test0020 - Test Case testing interval operation with an input that should always be true with added negations
  - " G[5] (!(!(x & x))) "
...
# test0027 - Test Case testing negation of conjunction of two different types of interval operations
  - "!( (G[5,10] x) & (G[2] y) )"
...
# test0035 - Test Case testing for complex global
  - "G[2,4](G[2]y)"