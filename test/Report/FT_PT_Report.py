...
#              results in a FT_PT_Results.txt file
#------------------------------------------------------------------------------------#
import subprocess
import os
...
__OracleDir__    = __AbsolutePath__+'../Oracle/FT_PT_Oracle/'
__ResultCDir__   = __AbsolutePath__+'../results/c_version/'

# Create the Results.txt
f = open("FT_PT_Results.txt",'w')
...
f = open("FT_PT_Results.txt",'r').read()
