...
#              results in a LargeFtResults.txt file
#------------------------------------------------------------------------------------#
import subprocess
import os
...
__OracleDir__    = __AbsolutePath__+'../Oracle/LargeFtOracle/'
__ResultCDir__   = __AbsolutePath__+'../results/c_version/'

# Create the Results.txt
f = open("LargeFtResults.txt",'w')
...
f = open("LargeFtResults.txt",'r').read()
