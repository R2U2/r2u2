...
class C2POParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "BASE_TYPE", 
                      "KW_VAR", "KW_DEF", "KW_SPEC", "KW_ORDER", "KW_SET", 
                      "LOG_NEG", "LOG_AND", "LOG_OR", "LOG_XOR", "LOG_IMPL", 
                      "LOG_IFF", "TRUE", "FALSE", "BW_NEG", "BW_AND", "BW_OR", 
                      "BW_XOR", "REL_EQ", "REL_NEQ", "REL_GTE", "REL_LTE", 
    ...
    class TermExprContext(ExprContext):
        ...
        def term(self):
            return self.getTypedRuleContext(C2POParser.TermContext,0)
    ...
    class LogNegExprContext(ExprContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitLogNegExpr" ):
                return visitor.visitLogNegExpr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ArithAddTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArithAddTerm" ):
                return visitor.visitArithAddTerm(self)
            else:
                return visitor.visitChildren(self)


    class TernaryTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTernaryTerm" ):
                return visitor.visitTernaryTerm(self)
            else:
                return visitor.visitChildren(self)


    class UnaryTermContext(TermContext):
    ...
    class SetTermContext(TermContext):
        ...
        def set_term(self):
            return self.getTypedRuleContext(C2POParser.Set_termContext,0)


        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitSetTerm" ):
                return visitor.visitSetTerm(self)
            else:
                return visitor.visitChildren(self)


    class RelTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitRelTerm" ):
                return visitor.visitRelTerm(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ArithMulTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArithMulTerm" ):
                return visitor.visitArithMulTerm(self)
            else:
                return visitor.visitChildren(self)


    class FuncTermContext(TermContext):
    ...
    class ParensTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitParensTerm" ):
                return visitor.visitParensTerm(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Set_termContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitSet_term" ):
                return visitor.visitSet_term(self)
            else:
                return visitor.visitChildren(self)
