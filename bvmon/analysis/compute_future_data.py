...
for file in files:
    ...
    with open(file, newline="") as csvfile:
        ...
        for row in reader:
            ...
            results[file][density]["bvmon"] = bvmon_throughput
...
for file in results:
    ...
    max_bvmon_throughput = max([results[file][density]["bvmon"] for density in results[file]])
    ...
    min_bvmon_throughput = min([results[file][density]["bvmon"] for density in results[file]])
    ...
    max_percent_diffs[file]["bvmon"] = (max_bvmon_throughput - min_bvmon_throughput) / max_bvmon_throughput * 100
...
for file in max_percent_diffs:
    ...
    print(f"Max percent difference for bvmon: {max_percent_diffs[file]['bvmon']:.2f}%")