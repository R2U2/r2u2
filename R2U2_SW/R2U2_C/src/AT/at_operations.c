...
void op_abs_diff_angle(at_instruction_t *instr)
{
	...
	AT_DEBUG_PRINT("	abs_diff_angle(%lf, %lf) = %lf\n",
...
void op_rate(at_instruction_t *instr)
{
	...
	AT_DEBUG_PRINT("	rate(%lf) = %lf - %lf\n",
		signal, signal, instr->filt_data_struct.prev);
