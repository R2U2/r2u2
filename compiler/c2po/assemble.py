...
PT_OPERATOR_MAP = {
    ...
    cpt.LogicalNegate: PTOperator.NOT,
...
def gen_bz_instruction(
    ...
    if isinstance(node, cpt.Signal):
        operand1 = node.signal_id
        operand2 = 0
    elif isinstance(node, cpt.Integer):
        operand1 = node.value
        operand2 = 0
    elif isinstance(node, cpt.Float):
        operand1 = node.value
        operand2 = 0
