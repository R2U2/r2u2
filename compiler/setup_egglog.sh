...
git clone git@github.com:egraphs-good/egglog-experimental.git "$SCRIPT_DIR"/deps/egglog-experimental
cd "$SCRIPT_DIR"/deps/egglog-experimental || { echo "Cannot find egglog git repo at $SCRIPT_DIR/deps/egglog-experimental" 1>&2 ; exit 2; }
